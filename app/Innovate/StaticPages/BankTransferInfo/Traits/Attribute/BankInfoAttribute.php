...
namespace Innovate\StaticPages\BankTransferInfo\Traits\Attribute;
...
trait BankInfoAttribute
{
    ...
    public function getEditButtonAttribute()
    {
        if (access()->can('edit-users')) {
            return '<a href="' . route('admin.bank_transfer_info.edit', $this->id) . '" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="' . trans('crud.edit_button') . '"></i></a> ';
        }
    ...
    public function getDeleteButtonAttribute()
    {
        if (access()->can('view-innovate-ecommerce')) {
            return '<a href="' . route('admin.bank_transfer_info.destroy', $this->id) . '" data-method="delete" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="' . trans('crud.delete_button') . '"></i></a>';
        }
